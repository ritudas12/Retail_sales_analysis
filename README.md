...
- **Total sale**:How many sales we have.
- **Unique Customers**:How many unique customers we have.
- **Total Category**:How many category we have.
...
The main goal of this project is to understand sales patterns and customer behavior using SQL queries and generate meaningful insights for business decisions
